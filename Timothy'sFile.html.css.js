...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Self-Made CSS -->
     ...
     <link rel="stylesheet" href="portfoliotim1.css">
  ...
  <style>
   ...
   #about {
     ...
     background: linear-gradient(135deg,grey,burlywood);
...
<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top timothy">
  <div class="container">
    <a class="navbar-brand brand-btn" href="#"> <strong> The Tim's Workshop 🧰🏍️<strong class=" knight-tag ">♘</strong> </strong> </a>
...
<section id="home" class="hero d-flex align-items-center">
  <div class="container text-center">
    <h1 class="display-4 fw-bold main-head">Greetings, I'm Timothy Jedric Cantre Facundo</h1>
    <p class="lead secondary-head"> Common Wealth Contestant | Trader | Junior Programmer </p>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <h2 style="text-align: center; margin: 35px;" class="about-me"> <strong> About Me </strong> </h2>
        <p>
          " My Hobbies is driving around slex or cruising in a bike"
        </p>
        <p>
        ...
        <div style="background-color: #181818; border-radius: 10px; ">
        <div class="mb-4 mb-lg-0" style="padding: 10px 15px;">
            <div class="text-content" style="text-align: center;">

            <p> Timothy did an unexpected outstanding thing on my project, and he also dealing with business partners. His knowledge and strategy skills are so impressive. The project results a huge sucess and thanks for his planning idea, dedication, and willingness to help when needed. He also made himself available at anytime. And i also reccomend his assistance for dealing with other clients. 5+++ </p>
            
            <h5> Paul </h5>
            <span> UpWork | Benlabien Inc. ( CEO ) </span>
            </div>
      ...
      <div class="col-lg-6 text-center">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0RQ-zKvSrw4BXu_248ml8r6mrF0qf4Lscyq2jcktFYQ&s=10"
             alt="Prince Guevara"
      ...
      <div class="col-md-4">
        <div class="card h-100">
          <div class="card-body">
            ...
            <p class="card-text">A website where i put my personal details and informations.</p>
            <a href="montecarlotechnologies.html" class="btn btn-primary">View</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card h-100">
          <div class="card-body">
            ...
            <p class="card-text">A short description of your project.</p>
      ...
      <div class="col-md-4">
        <div class="card h-100">
          <div class="card-body">
            ...
            <p class="card-text">A short description of your project.</p>
            <a href="newtestswalfire.html" class="btn btn-primary">View</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="container">
<h2 class="text-center mb-4">Timothy's Management Consultant</h2>
...
autoWidth: false,
data: [
{ id: "1", name: "Klyde", email: "klydelozada@email.com", age: "16" },

...
#completedOrdersTable tbody tr:nth-child(even) { background: #f4e7dd; }
#completedOrdersTable tbody tr:nth-child(odd) { background: #f8f1eb; }
...
@media (max-width: 768px) {
  ...
  /* Cart below products */
  .cart-panel { margin-top: 15px; width: 100%; }

  /* Smaller cart table */
  .cart-panel table { font-size: 12px; }

  /* Fee container smaller padding */
  .fee-container { padding: 8px; }

  /* Buttons smaller */
  .checkout-btn, .clear-btn { font-size: 12px; padding: 5px 10px; }
  
  .add-btn { font-size: 12px; padding: 5px 35px; }

  /* Completed orders table horizontal scroll */
  #completedOrdersTable_wrapper { overflow-x: auto; padding: 5px; }

  /* Analytics stack vertically */
  #analyticsSection .row { flex-direction: column; }
  #analyticsSection .col-md-6 { width: 100%; margin-bottom: 15px; }
  
  /* Center product cards on mobile */
  #productList .col-md-4 {
      flex: 0 0 75%;      /* shrink width to 90% of container */
      max-width: 90%;     /* enforce max-width */
      margin: 0 auto 15px auto; /* center horizontally and add spacing below */
  }
...
const products = [
  ...
  { sku: "TAO-CHOC", name: "Tao Choco n' Crust (10 pcs)", price: 99, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANJU-CHOC.png" },
  
  { sku: "TAO-CUST", name: "Tao Custard (10 pcs)", price: 99, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANJU-CUST.png" },
  
  { sku: "TAO-MOZZ", name: "Tao Mozzarella (10 pcs)", price: 99, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANJU-MOZZ.png" },
  
  {	sku: "TAO-STRAW", name: "Tao Strawberry Waffle", price: 99, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANJU-STRAW.png" },
  
  { sku: "TAO-UBE", name: "Tao Ube Waffle (10 pcs)", price: 99, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANJU-UBE.png" },
  
  { sku: "HAO-BEEF", name: "Hao Beef Taco", price: 49, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANT-BEEF.png" },
  
  { sku: "HAO-PEPP", name: "Hao Pepperoni", price: 49, stock: 100, imgUrl: "https://ayosnegosyoph.com/public/product/MANT-PEPP.png" }
];
...
$(document).ready(() => {
  ...
  // FIX: recalc totals when service or payment changes
    ...
    $("#productList").append(`
      <div class="col-md-4">
        <div class="product-card">
          ...
          <h6>${p.name}</h6>
          <p style="font-size: 13px; color: #555; margin-bottom:5px;"><strong>${sku}</strong></p>
...
function checkout() {
  ...
  Swal.fire({
    ...
    // Add row to completed orders table

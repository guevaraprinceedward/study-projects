  ...
  <div class="container">
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-md-4 d-flex justify-content-center">
        <div class="card h-100 text-center p-3" style="max-width: 320px;">
          <img src="https://cdn.freebiesupply.com/logos/large/2x/facebook-icon-logo-png-transparent.png" alt="Facebook Logo" class="mx-auto mb-3" style="width: 50%; padding: 5px; margin-top: 10px">
          <div class="card-body">
      ...
      <div class="col-md-4 d-flex justify-content-center">
        <div class="card h-100 text-center p-3" style="max-width: 320px;">
          <img src="https://img.freepik.com/premium-vector/instagram-icon_768467-672.jpg?semt=ais_hybrid&w=740&q=80" alt="Instagram Logo" class="mx-auto mb-3" style="width:50%; padding 5px; margin-top: 10px;">
          <div class="card-body">
      ...
      <div class="col-md-4 d-flex justify-content-center">
        <div class="card h-100 text-center p-3" style="max-width: 320px;">
          <img src="assets/logos/tiktok-logo.png" alt="TikTok Logo" class="mx-auto mb-3" style="width:60px;">
          <div class="card-body">

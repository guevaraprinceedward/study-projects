...
{name:"Caramel Latte", price:125, stock:35, imgUrl:"https://media.istockphoto.com/id/673742908/photo/iced-caramel-latte-coffee-in-a-tall-glass.jpg?s=612x612&w=0&k=20&c=L5vH2S7jFqzOM8qGIK-iLKrUfSGGGf68ZPmR5xrdAKU="},
...
let searchTerm=$("#searchProduct").val().toLowerCase();
$("#productList").empty();
...
<small style="color:${p.stock===0?'red':'black'}">
...
<td>
<button class="qty-btn-ctm btn-sm" onclick="changeQty(${i},-1)">-</button>
<button class="qty-btn-ctm btn-sm" onclick="changeQty(${i},1)">+</button>
</td>
</tr>`;
});
...
let service=parseFloat($("#serviceCharge").val())||0;
let method=$("#paymentMethod").val();

let paymentPercent =
method==="cash" ? 0.10 :
method==="gcash" ? 0.20 : 0.35;

let tax=subtotal*paymentPercent;
...
/* ---------- CHANGE QTY ---------- */
window.changeQty=function(i,amt){
...
<!-- NEW CHANGES IN SYSTEMS -->
<!-- NEW CREATED AT MAR 07 2026: 1:02PM -->

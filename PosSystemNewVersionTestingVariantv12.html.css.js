...
.profile-container img {
  width: 105px;
  height: 105px;
  border-radius: 50%; /* 👉 makes it circle (profile look) */
  object-fit: cover;
...
<div class="profile-container">
  <img src="https://raw.githubusercontent.com/guevaraprinceedward/study-projects/refs/heads/master/CEO.Mr.Severino.Robillios.Image.png" alt="User Profile">
  <h6 class="profile-name">CEO: Mr. Severino Robillios</h6>
  <p class="profile-role">CEO of My Ayos Coffee Negosyo</p>
</div>

<h4> My Ayos Coffee Negosyo POS System </h4>
...
const products = [
  ...
  { sku: "HAO-MAPL-GLAZ", name: "Hao Maple Glaze", price: 49, stock: 100, category: "hao", imgUrl: "" },
  
  { sku: "HAO-VEL-MELT", name: "Hao Cheddar Velvet Melt", price: 49, stock: 100, category: "hao", imgUrl: "" },
  
  { sku: "HAO-SALM-CRME", name: "Hao Smoked Salmon Crème", price: 49, stock: 100, category: "hao", imgUrl: "" }
